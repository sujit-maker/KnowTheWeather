...
<body>
    ...
    <style>
        ...
        #clock img {
            width: 50px; /* Adjust the width of the clock image */
            height: 50px; /* Adjust the height of the clock image */
    ...
    function updateClock() {
        ...
        document.getElementById('clock').innerHTML = '<img src="clock.png" alt="Clock">' + timeString;
        ...
        // Call the updateClock function when the page is loaded
